...
namespace WCCG.DentalMock.UI.Swagger;
...
public class SwaggerProcessMessageOperationFilter : IOperationFilter
{
    ...
    private static void AddResponses(OpenApiOperation operation)
    {
        operation.Responses = new OpenApiResponses
        {
            ...
            {
                "400 Internal", new OpenApiResponse
                {
                    ...
                    {
                        {
                            FhirConstants.FhirMediaType, new OpenApiMediaType
                            {
                                Example = new OpenApiString(File.ReadAllText("Swagger/Examples/create-referral-bad-request-internal.json")),
                            }
                        }
                    }
                }
            ...
            {
                "400 External", new OpenApiResponse
                {
                    Description = "Bad Request",
                    Content = new Dictionary<string, OpenApiMediaType>
                    {
                        {
                            FhirConstants.FhirMediaType, new OpenApiMediaType
                            {
                                Example = new OpenApiString(File.ReadAllText("Swagger/Examples/create-referral-bad-request-external.json")),
                            }
                        }
                    }
                }
                    ...
                    {
                        {
                            ...
                            {
                                Example =
                                    new OpenApiString(File.ReadAllText("Swagger/Examples/create-referral-internal-server-error.json")),
                            }
                        }
                    }
                }
                    ...
                    {
                        {
                            ...
                            {
                                Example =
                                    new OpenApiString(File.ReadAllText("Swagger/Examples/create-referral-external-server-error.json")),
                            }
                        }
                    }
                }
